...
clean:
	rm *.o Main uname chmod cat ln cmd_rmFile cmd_rmDir cmd_mkDir cmd_rmDirR ps kill cmd_redirect

gitclean:
	git rm *.o Main uname chmod cat ln cmd_rmFile cmd_rmDir cmd_mkDir cmd_rmDirR ps kill cmd_redirect
